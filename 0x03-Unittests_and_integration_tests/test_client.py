...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_has_license(self, data: Dict, key: str, value: bool) -> None:
        """Tests the `has_license` method."""
        gh_org_client = GithubOrgClient("google")
        client_has_license = gh_org_client.has_license(data, key)
        self.assertEqual(client_has_license, value)
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        def get_payload(url):
            if url in routes:
                return Mock(**{"json.return_value": routes[url]})
            return HTTPError
